...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Trigger Trail', "Turn ON/OFF Trail for Character. \nValue 1: 0 = visible false, 1 = visible true \nValue 2: 0 = trail to BF, 1 = trail to Dad"],
		['Trigger dad Things', "Trun ON/OFF Dad event things... u know yea? \nValue 1: 0 = Shake false, 1 = Shake true \nValue 2: 0 = HP Drain false, 1 = HP Drain true"],
		['Diamond Attack', "Value 1: Bool about arm ready animation.\n0 = Attack animation, 1 = ready animation.\nValue 2: How much you attack. set to 1 or 2"],
		['Play Count Sound', "Value 1: Count number. \numm... just using 3 or 2 yea"]
	];
